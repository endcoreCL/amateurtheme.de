...
class acf_field_google_font_selector extends acf_field {
	...
	function render_field( $field ) {
		...
		<div class="acfgfs-font-selector">
			...
			<div class="acfgfs-form-control acfgfs-font-family" >
                <div class="acfgfs-form-control-title"><?php _e('Schriftart', 'amateurtheme-backend') ?></div>
			...
			<div class="acfgfs-form-control acfgfs-font-variants" style="width: 40%">
				<div class="acfgfs-form-control-title"><?php _e('Variante', 'amateurtheme-backend') ?></div>
		...
		<?php $font = $current_font_family; ?>
        <div class='acfgfs-preview' style="width: 90%">

            <link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=<?php echo $font ?>">

            <div style='font-family:"<?php echo $font ?>" !important'>
	...
	function input_admin_enqueue_scripts() {
		...
		$dir =  get_template_directory_uri() . '/library/plugins/acf/field-type-google-font/';
