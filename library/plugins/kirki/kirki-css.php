...
function at_inline_css() {
     ...
     * General
     */
    $bo_bi_color = Kirki::get_option( 'bo_bi_color' );
    $bo_bi_image = Kirki::get_option( 'bo_bi_image' );
    $bo_bi_repeat = Kirki::get_option( 'bo_bi_repeat' );
    $bo_bi_size = Kirki::get_option( 'bo_bi_size' );
    $bo_bi_attach = Kirki::get_option( 'bo_bi_attach' );
    $bo_bi_position = Kirki::get_option( 'bo_bi_position' );
     ...
     * Typography
     */
    //$ty_ft = Kirki::get_option( '', 'ty_ft' );
    //$ty_fh = Kirki::get_option( '', 'ty_fh' );
    //$ty_tc = Kirki::get_option( '', 'ty_tc' );
    ...
    $output = '
        body{
            background-color: ' . $bo_bi_color . ';
            ' . ($bo_bi_image ? 'background-image: url(' . $bo_bi_image . ');' : '') . '
            ' . ($bo_bi_repeat ? 'background-repeat: ' . $bo_bi_repeat . ';' : '') . '
            ' . ($bo_bi_size ? 'background-size: ' . $bo_bi_size . ';' : '') . '
            ' . ($bo_bi_attach ? 'background-attachment: ' . $bo_bi_attach . ';' : '') . '
            ' . ($bo_bi_position ? 'background-position: ' . str_replace('-', ' ',$bo_bi_position) . ';' : '') . '
        }
