...
function at_import_ac_panel ()
{
    ...
    if ( is_array( $_REQUEST ) ) :
        if ( isset( $_REQUEST['action'] ) ) :
            if ( $_REQUEST['action'] == 'save' ) {
                echo '<div id="message" class="updated fade"><p><strong>Einstellungen gespeichert.</strong></p></div>';
            }
    ...
    <div class="wrap" id="at-import-page-wrap">
        <div id="at-import-page-header">
            <h1><?php _e( 'Import &rsaquo; AmateurCommunity', 'amateurtheme' ); ?></h1>
                    ...
                    <div class="metabox-holder postbox no-padding-top">
                        ...
                        <div class="inside">
                            <form method="post">
                                ...
                                <div class="form-group">
                                    <label for="at_ac_post_status"><?php _e( 'Status für neue Videos', 'amateurtheme' ); ?></label>
                                    <select name="at_ac_post_status" class="form-control">
                                        <option value="publish" <?php echo( get_option( 'at_ac_post_status' ) == 'publish' ? 'selected' : '' ); ?>><?php _e( 'Veröffentlicht', 'amateurtheme' ); ?></option>
                                        <option value="draft" <?php echo( get_option( 'at_ac_post_status' ) == 'draft' ? 'selected' : '' ); ?>><?php _e( 'Entwurf', 'amateurtheme' ); ?></option>
                                    </select>
                                </div>

                                <div class="form-group">
                                    <label for="at_ac_fsk18"><?php _e( 'FSK 18 Inhalte', 'amateurtheme' ); ?></label>
                                    <select name="at_ac_fsk18" class="form-control">
                                        <option value="0" <?php echo( get_option( 'at_ac_fsk18' ) == '0' ? 'selected' : '' ); ?>><?php _e( 'Nein', 'amateurtheme' ); ?></option>
                                        <option value="1" <?php echo( get_option( 'at_ac_fsk18' ) == '1' ? 'selected' : '' ); ?>><?php _e( 'Ja', 'amateurtheme' ); ?></option>
                                    </select>
                                </div>

                                <div class="form-group">
                                    <label for="at_ac_video_description"><?php _e( 'Beschreibung Importieren', 'amateurtheme' ); ?></label>
                                    <select name="at_ac_video_description" class="form-control">
                                        <option value="0" <?php echo( get_option( 'at_ac_video_description' ) == '0' ? 'selected' : '' ); ?>><?php _e( 'Nein', 'amateurtheme' ); ?></option>
                                        <option value="1" <?php echo( get_option( 'at_ac_video_description' ) == '1' ? 'selected' : '' ); ?>><?php _e( 'Ja', 'amateurtheme' ); ?></option>
                                    </select>
                                ...
                                <table class="at-table at-import-table">
                                        ...
                                        foreach ( $amateure as $item ) :
                                            ...
                                            <tr>
                                                ...
                                                <td class="cron-video-count">
                                                    <?php echo at_import_ac_get_video_count( $item->object_id ); ?>
                                                </td>
                                                <td class="cron-video-imported">
                                                    <?php echo at_import_ac_get_imported_video_count( $item->object_id ); ?>
                                                </td>
                                    ...
                                    <tr>
                                        <td colspan="6">
                                            ...
                                            <input type="hidden" name="network" value="ac"/>
                ...
                <div id="apilog" class="at-import-tab">
                    <div id="at-import-settings" class="metabox-holder postbox">
                        ...
                        <div class="inside">
                            ...
                            <p><a href="" class="clear-api-log button" data-type="ac"><?php _e( 'Log löschen', 'amateurtheme' ); ?></a></p>
