<?php
function at_import_pornme_panel() {
    ...
    <div class="wrap" id="at-import-page-wrap">
		<div id="at-import-page-header">
			<h1><?php _e('Import &rsaquo; PornMe', 'amateurtheme'); ?></h1>
                        ...
                        <div class="inside">
                            <form method="post">
                                <div class="form-group">
                                    <label for="at_pornme_wmb"><?php _e('Webmaster ID', 'amateurtheme'); ?></label>
                                    <input name="at_pornme_wmb" id="at_pornme_wmb" type="text" value="<?php echo (get_option('at_pornme_wmb') ? get_option('at_pornme_wmb') : '') ?>" class="form-control"/>
                                </div>

                                <div class="form-group">
                                    <label for="at_pornme_post_status"><?php _e('Status für neue Videos', 'amateurtheme'); ?></label>
                                    <select name="at_pornme_post_status" class="form-control">
                                        <option value="publish" <?php echo (get_option('at_pornme_post_status') == 'publish' ? 'selected' : ''); ?>><?php _e('Veröffentlicht', 'amateurtheme'); ?></option>
                                        <option value="draft" <?php echo (get_option('at_pornme_post_status') == 'draft' ? 'selected' : ''); ?>><?php _e('Entwurf', 'amateurtheme'); ?></option>
                                    </select>
                                </div>

                                <div class="form-group">
                                    <label for="at_pornme_fsk18"><?php _e('FSK 18 Inhalte', 'amateurtheme'); ?></label>
                                    <select name="at_pornme_fsk18" class="form-control">
                                        <option value="0" <?php echo (get_option('at_pornme_fsk18') == '0' ? 'selected' : ''); ?>><?php _e('Nein', 'amateurtheme'); ?></option>
                                        <option value="1" <?php echo (get_option('at_pornme_fsk18') == '1' ? 'selected' : ''); ?>><?php _e('Ja', 'amateurtheme'); ?></option>
                                    </select>
                                </div>

                                <div class="form-group">
                                    <label for="at_pornme_video_description"><?php _e('Beschreibung Importieren', 'amateurtheme'); ?></label>
                                    <select name="at_pornme_video_description" class="form-control">
                                        <option value="0" <?php echo (get_option('at_pornme_video_description') == '0' ? 'selected' : ''); ?>><?php _e('Nein', 'amateurtheme'); ?></option>
                                        <option value="1" <?php echo (get_option('at_pornme_video_description') == '1' ? 'selected' : ''); ?>><?php _e('Ja', 'amateurtheme'); ?></option>
                                    </select>
                                ...
                                <table class="at-table at-import-table">
                                    ...
                                    <tr>
                                        <td colspan="6">
                                            ...
                                            <input type="hidden" name="network" value="pornme" />
                ...
                <div id="apilog" class="at-import-tab">
                    <div id="at-import-settings" class="metabox-holder postbox">
                        ...
                        <div class="inside">
                            ...
                            <p><a href="" class="clear-api-log button" data-type="pornme"><?php _e('Log löschen', 'amateurtheme'); ?></a></p>
                            <table class="at-table apilog">
                                ...
                                <tbody>
                                    <?php
                                    $log = get_option('at_pornme_api_log');
                                    if($log) {
