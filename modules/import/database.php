...
if ( ! function_exists( 'at_import_install_tables' ) ) {
    /**
...
if ( ! function_exists( 'at_import_database_tables' ) ) {
    /**
     * at_import_database_tables
     *
     */
    ...
    function at_import_database_tables ()
    {
        ...
        if ( $wpdb->get_var( "show tables like '" . AT_CRON_TABLE . "'" ) != AT_CRON_TABLE ) {
            $sql = "CREATE TABLE " . AT_CRON_TABLE . " (
                ...
                options longtext,
                processing int(1),
                scrape int(1) DEFAULT '0',
                import int(1) DEFAULT '0',
                last_pos bigint(20) DEFAULT '0',
                created bigint(20) DEFAULT '0',
                updated bigint(20) DEFAULT '0',
                skipped bigint(20) DEFAULT '0',
