...
function at_import_menu()
{
	add_menu_page( 'at_import_dashboard', __( 'Import', 'amateurtheme' ), 'administrator', 'at_import_dashboard', "at_import_dashboard", "dashicons-smiley" );
	add_submenu_page( 'at_import_dashboard', __( 'Big7', 'amateurtheme' ), __( 'Big7', 'amateurtheme' ), 'administrator', 'at_import_big7_panel', 'at_import_big7_panel' );
	add_submenu_page( 'at_import_dashboard', __( 'MyDirtyHobby', 'amateurtheme' ), __( 'MyDirtyHobby', 'amateurtheme' ), 'administrator', 'at_import_mydirtyhobby_panel', 'at_import_mydirtyhobby_panel' );
	add_submenu_page( 'at_import_dashboard', __( 'AmateurCommunity', 'amateurtheme' ), __( 'AmateurCommunity', 'amateurtheme' ), 'administrator', 'at_import_ac_panel', 'at_import_ac_panel' );
}

function at_import_dashboard()
{
	echo 'Nix zu sehen hier!';
}
...
{
	if ( strpos( $page, 'at_import_' ) === false ) {
		return;
	}
